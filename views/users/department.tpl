...
<section> {{template "inc/left.tpl" .}}
  ...
  <div class="main-content" >
    ...
    <div class="header-section">
      ...
      <!--toggle button end-->
      <!--search start-->
      <form class="searchform" action="/department/manage" method="get">
                    ...
                    <tr>
                      ...
                      <td><div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="/department/edit/{{$v.Id}}">编辑</a></li>
                            <li role="separator" class="divider"></li>
                            {{if eq 1 $v.Status}}
                            <li><a href="javascript:;" class="js-depart-single" data-id="{{$v.Id}}" data-status="2">屏蔽</a></li>
                            {{else}}
                            <li><a href="javascript:;" class="js-depart-single" data-id="{{$v.Id}}" data-status="1">正常</a></li>
                            {{end}}
                          </ul>
                        </div></td>
                    </tr>
