  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <ul class="breadcrumb pull-left">
        <li> <a href="/user/show/{{.LoginUserid}}">主页</a> </li>
        <li> <a href="/leave/manage">审批管理</a> </li>
        <li class="active"> 请假单详情 </li>
      </ul>
      <div class="pull-right"> <a href="javascript:history.back();" class="btn btn-default">返回</a> <a href="/leave/approval" class="hidden-xs btn btn-default" style="padding:4px;">待审批</a> <a href="/leave/add" class="btn btn-success">+我要请假</a> </div>
    </div>
            ...
            <div class="single-blog">
              <div class="panel">
                <div class="panel-body">
                  ...
                  <p class="text-center auth-row"> By <a href="/user/show/{{.leave.Userid}}">{{getRealname .leave.Userid}}</a> | {{getDateMH .leave.Changed}}</p>
                  <div id="print">
                    <table class="table table-bordered" border="1">
                      ...
                      <tr>
                        <td width="72">姓名</td>
                        <td width="62">{{getRealname .leave.Userid}}</td>
                        <td width="70">部门</td>
                        <td width="77">{{getDepartmentsName .leave.Userid}}</td>
                        <td width="80">职位</td>
                        <td width="93">{{getPositionsName .leave.Userid}}</td>
                      </tr>
                      <tr>
                        <td>类型</td>
                        <td colspan="5">{{getLeaveType .leave.Type}}</td>
                      </tr>
                      <tr>
                        <td>事由</td>
                      ...
                      <tr>
                        <td>日期</td>
                        <td colspan="5">{{getDate .leave.Started}}至{{getDate .leave.Ended}}</td>
                      </tr>
                      <tr>
                        <td>天数</td>
                        <td colspan="5">{{.leave.Days}}天</td>
                      </tr>
                      <tr  class="hide">
                        <td>审核人</td>
                        <td colspan="5">&nbsp;</td>
              ...
              {{if ne .leave.Userid .LoginUserid}}
              <div class="panel">
                <div class="panel-body">
