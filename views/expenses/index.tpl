...
<section> {{template "inc/left.tpl" .}}
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="/expense/manage" class="hidden-xs btn btn-default">全部</a> <a h="/expense/approval" id="validated" r="{{.LoginRole}}" class="btn btn-warning" style="padding:4px;cursor: pointer;">待审批</a> <a href="/expense/add" class="btn btn-success">+我要报销</a> </div>
          ...
          <section class="panel">
            ...
            <div class="panel-body">
              <table class="table table-hover general-table">
                ...
                {{range $k,$v := .expenses}}
                <tr>
                  <td class="hidden-phone">{{getDate $v.Created}}</td>
                  ...
                  <td> {{if eq $v.Status 1}}
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="/expense/edit/{{$v.Id}}">编辑</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:;" class="js-expense-delete" data-op="delete" data-id="{{$v.Id}}">删除</a></li>
                        {{if eq $v.Status 1}}
                        <li role="separator" class="divider"></li>
                        <li><a href="javascript:;" class="js-expense-status" data-op="status" data-id="{{$v.Id}}">正常</a></li>
                        {{end}}
                      </ul>
                    </div>
                    {{else}} <a href="/expense/approval/{{$v.Id}}"> 查看 </a> {{end}} </td>
                </tr>
                {{else}}
                <tr>
