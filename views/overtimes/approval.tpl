...
<section> {{template "inc/left.tpl" .}}
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="/overtime/manage" class="btn btn-success" style="padding:4px;">加班</a> <a href="/overtime/approval?filter=wait" class="btn btn-default {{if eq .condArr.filter "wait"}}active{{end}}" style="padding:4px;">待审批</a> <a href="/overtime/approval?filter=over" class="btn btn-default hidden-xs {{if eq .condArr.filter "over"}}active{{end}}" style="padding:4px;">已审核</a> </div>
    </div>
    <!-- page heading end-->
    <!--body wrapper start-->
    <div class="wrapper">
            ...
            <div class="panel-body">
              <table class="table table-hover general-table">
                ...
                <tr>
                  ...
                  <td><a href="/overtime/approval/{{$v.Id}}"> 审批 </a> </td>
                </tr>
                {{else}}
                <tr>
