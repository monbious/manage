...
<section> {{template "inc/left.tpl" .}}
  ...
  <div class="main-content" >
    ...
    <div class="page-heading">
      ...
      <div class="pull-right"> <a href="/overtime/manage" class="btn btn-default hidden-xs">全部</a> <a h="/overtime/approval" id="validated" r="{{.LoginRole}}" class="btn btn-warning" style="padding:4px;cursor: pointer;">待审批</a> <a href="/overtime/add" class="btn btn-success">+我要加班</a> </div>
